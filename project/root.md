 ...
 * File: /Users/martinbechard/dev/claudeext/claudeext.js
 ...
 * Copyright (c) 2024 Martin Bechard <martin.bechard@DevConsult.ca>
 * This software is licensed under the MIT License.
 * File: /Users/martinbechard/dev/claudeext/jest.config.ts
const config = {
  preset: "ts-jest",
...
```json
{
  ...
  "version": "1.0.0",
  "description": "Chrome extension for Claude",
  "scripts": {
    "build": "webpack --mode=production",
    "build:debug": "projectPackager.zsh && webpack --mode=development",
...
```json
{
  "compilerOptions": {
    ...
    "inlineSourceMap": false, // Keep source maps as separate files
 ...
 * Copyright (c) 2024 Martin Bechard <martin.bechard@DevConsult.ca>
 * This software is licensed under the MIT License.
 * File: /Users/martinbechard/dev/claudeext/webpack.config.js
 * This was generated by Claude Sonnet 3.5, with the assistance of my human mentor
 */
